        ...
        <form action={createEvent} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              minLength={3}
              maxLength={120}
              placeholder="Team dinner, Birthday party..."
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-white/30 transition-all duration-200 focus:border-violet-500/50 focus:outline-none focus:ring-2 focus:ring-violet-500/20 resize-none"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              name="eventDate"
              type="datetime-local"
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white transition-all duration-200 focus:border-violet-500/50 focus:outline-none focus:ring-2 focus:ring-violet-500/20 [color-scheme:dark]"
            />
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            <button
              type="submit"
              className="rounded-lg bg-violet-600 px-6 py-2.5 text-sm font-medium text-white shadow-lg shadow-violet-600/25 transition-all duration-200 hover:bg-violet-500 hover:shadow-violet-500/40 hover:scale-105"
            >
              Create Event
            </button>
            <Link
