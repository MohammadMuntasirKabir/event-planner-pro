        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <RevealElement key={feature.title} delay={i * 100}>
              <div className="feature-card group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-500 hover:border-violet-500/30 hover:bg-white/10 hover:shadow-xl hover:shadow-violet-500/5 hover:-translate-y-1">
